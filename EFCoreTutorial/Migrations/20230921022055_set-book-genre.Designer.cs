...
namespace EFCoreTutorial.Migrations
{
    ...
    [Migration("20230921022055_set-book-genre")]
    partial class setbookgenre
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookGenre", b =>
                {
                    b.HasOne("EFCoreTutorial.Models.Domain.Book", null)
                        .WithMany()
                        .HasForeignKey("BooksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreTutorial.Models.Domain.Genre", null)
                        .WithMany()
